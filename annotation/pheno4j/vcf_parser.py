...
parser=argparse.ArgumentParser(description='Arguments to vcf_importer.py')
...
print('PersonId','VariantId',sep=',',file=hom_variant_file)
print('PersonId','VariantId',sep=',',file=het_variant_file)
...
for l in infile:
    ...
    for i, g in enumerate(GENOTYPES):
        if g==1:
            print(SAMPLES[i],VARIANT_ID,sep=',',file=hom_variant_file)
        elif g==2:
            print(SAMPLES[i],VARIANT_ID,sep=',',file=het_variant_file)
...
CREATE (gv)-[:HetVariantToPerson]->(person)
""" % het_variant_filename
print(s)
