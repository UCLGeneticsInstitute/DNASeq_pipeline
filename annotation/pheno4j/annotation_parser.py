...
print('gene_id','gene_name',sep=',',file=Gene_file)
...
print('transcript_id',sep=',',file=Transcript_file)
...
print('variantId','gene_id',sep=',',file=GeneticVariantToGene_file)
...
print('variantId','transcript_id',sep=',',file=GeneticVariantToTranscriptVariant_file)
...
print('transcript_id','gene_id',sep=',',file=TranscriptToGene_file)
